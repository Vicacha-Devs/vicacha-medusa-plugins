...
export const adminCompaniesMiddlewares: MiddlewareRoute[] = [
  ...
  {
    method: ["GET"],
    matcher: "/admin/b2b/companies/:id/employees",
    middlewares: [
      validateAndTransformQuery(
        AdminGetEmployeeParams,
  ...
  {
    method: ["GET"],
    matcher: "/admin/b2b/companies/:id/employees/:employee_id",
    middlewares: [
      validateAndTransformQuery(
        AdminGetEmployeeParams,
        adminEmployeeQueryConfig.retrieve
  ...
  {
    method: ["POST"],
    matcher: "/admin/b2b/companies/:id/approval-settings",
    middlewares: [
